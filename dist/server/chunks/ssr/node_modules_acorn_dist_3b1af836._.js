...
"[project]/node_modules/acorn/dist/acorn.js [app-rsc] (ecmascript)": ((__turbopack_context__) => {
...
(function(global, factory) {
    ...
    pp$8.isUsingKeyword = function(isAwaitUsing, isFor) {
        ...
        if (isAwaitUsing) {
            ...
            if (this.input.slice(next, awaitEndPos) !== "using" || awaitEndPos === this.input.length || isIdentifierChar(after = this.input.charCodeAt(awaitEndPos)) || after > 0xd7ff && after < 0xdc00) {
                return false;
            }
        ...
        if (isFor) {
            ...
            if (this.input.slice(next, ofEndPos) === "of") {
                if (ofEndPos === this.input.length || !isIdentifierChar(after$1 = this.input.charCodeAt(ofEndPos)) && !(after$1 > 0xd7ff && after$1 < 0xdc00)) {
                    return false;
                }
            }
        }
...
"[project]/node_modules/acorn/dist/acorn.mjs [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=node_modules_acorn_dist_3b1af836._.js.map