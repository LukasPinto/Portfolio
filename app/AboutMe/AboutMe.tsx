...
import { Card, Stack, Box, Heading, Text, Separator, Flex, Center, Image } from '@chakra-ui/react';
...
export default function AboutMe() {
  ...
  return (<>
    <Stack direction='column'>
      ...
      <Stack direction={{ base: 'row', sm: 'column', md: 'column', lg: 'row' }} marginLeft={2} marginRight={2}>
        <Box>
          <Heading size='4xl' >
            Sobre mí
